...
```{r}
# generate data
df <- generate_data(scenario(npred = 16), ev = 0.02, n.level = 0.5)
df
```
```{r}
# all together
...
for (i in 1:2000){                                          
  df      <- generate_data(scenario(npred = 28, dmu = 0.29, dsig = 0.2), ev = 0.02, n.level = 0.5)
  auc[i]  <- get_auc(df)
}
...
```{r}
delta_mu_vec  <- c(0.61, 0.61, "X", 0.48, 0.48, 0.35, 0.42, 0.42, 0.29, 0.62, 0.62, 0.56, 0.50, 0.50, 0.44, 0.43, 0.43, 0.38, 0.62, 0.62, 0.58, 0.50, 0.50, 0.47, 0.44, 0.44, 0.40)
delta_sig_vec <- c(0.20, 0.20, "X", 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20, 0.20)
auc_vec       <- c(0.85, 0.85, "X", 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85, 0.85)
sd_vec        <- c(0.02, 0.03, "X", 0.02, 0.02, 0.05, 0.02, 0.01, 0.03, 0.02, 0.02, 0.05, 0.01, 0.01, 0.03, 0.01, 0.01, 0.03, 0.01, 0.01, 0.04, 0.01, 0.01, 0.03, 0.01, 0.01, 0.02)
```
